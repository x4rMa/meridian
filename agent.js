...
const INTENT_TOOLS = {
  ...
  positions:   new Set(["get_my_positions", "get_position_pnl", "get_wallet_balance", "set_position_note", "set_hold_until", "get_wallet_positions"]),
...
const INTENT_PATTERNS = [
  ...
  { intent: "positions",   re: /\b(position|portfolio|open|pnl|yield|range|hold)\b/i },
